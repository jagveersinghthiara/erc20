...
var web3 = new Web3(new Web3.providers.HttpProvider("https://ropsten.infura.io/v3/a1e50c1aa31f485e95586390749939f8"));


// var web3 = require('etherscan-api').init('PQZ69HAQSIEN9WJ9ZSTR83V2SKHKTRSB39','ropsten');
// console.log(web3);

var balance = web3.eth.getBalance('0xde0b295669a9fd93d5f28d9ec85e40f4cb697bae');
